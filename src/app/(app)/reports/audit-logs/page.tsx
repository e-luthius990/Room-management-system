...
const AUDIT_LOG_PERMISSIONS = ["audit_logs.view", "reports.view_audit"] as const;
...
export default async function ReportAuditLogsPage(): Promise<React.JSX.Element> {
  await requireAnyPermission([...AUDIT_LOG_PERMISSIONS]);
